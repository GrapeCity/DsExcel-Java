...
> - Download gcexcel jar package from [Maven Central Repository](https://mvnrepository.com/search?q=gcexcel)
> - Copy gcexcel-2.0.0.jar into project library folder, and add it as a dependency library
>
> **Gradle Project**
> - Open the build.gradle and append below script in in the dependencies block
> ```xml
> compile("com.grapecity.documents:gcexcel:2.0.0")
> ```
>
> **Maven Project**
