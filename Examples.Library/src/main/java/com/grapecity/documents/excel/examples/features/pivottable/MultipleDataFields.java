...
public class MultipleDataFields extends ExampleBase {
    ...
    public void execute(Workbook workbook) {
        ...
        IPivotField sumDataField = pivottable.addDataField(field_Amount, "sum amount", ConsolidationFunction.Sum);
        sumDataField.setNumberFormat("$#,##0.00");
