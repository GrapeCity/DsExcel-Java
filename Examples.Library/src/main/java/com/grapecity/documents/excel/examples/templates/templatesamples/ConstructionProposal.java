...
public class ConstructionProposal extends ExampleBase {
	@Override
	public void execute(Workbook workbook) {
        //Load template file from resource
        InputStream templateFile = this.getResourceStream("xlsx/Template_ConstructionProposal.xlsx");
        ...
        java.sql.ResultSet datasource = new GcMockResultSet(this.getResourceStream("data/construction proposal.csv"));
	...
	public String getTemplateName() {
        return "Template_ConstructionProposal.xlsx";
	}
	...
	public String[] getResources() {
        return new String[] { "xlsx/Template_ConstructionProposal.xlsx", "data/construction proposal.csv" };
	}
