...
public class CreateChartWithCustomName extends ExampleBase {
    @Override
    public void execute(Workbook workbook) {
        IWorksheet worksheet = workbook.getWorksheets().get(0);
        IShape shape = worksheet.getShapes().addChart("Area chart", ChartType.Area, 250, 20, 360, 230);
        ...
        // Get chart by name
        IShape areaChart = worksheet.getShapes().get("Area chart");
