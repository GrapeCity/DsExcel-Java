...
public class GS1128 extends ExampleBase {
	@Override
	public void execute(Workbook workbook) {
		...
		for (int i = 4; i < 6; i++)
		{
			worksheet.getRange("D" + i).setFormula("=BC_GS1_128" + "(C" + i + ")");
			worksheet.getRange("E" + i).setFormula("=BC_GS1_128" + "(C" + i + ", , , false))");
			worksheet.getRange("F" + i).setFormula("=BC_GS1_128" + "(C" + i + ", , , true, \"top\", \"Arial\", \"normal\")");
		}
	}
	@Override
