...
public class LayoutAndFormatOptions extends ExampleBase {
    ...
    public void execute(Workbook workbook) {
        ...
        IPivotField field_Order = pivottable.getPivotFields().get("Order ID");
        field_Order.setOrientation(PivotFieldOrientation.PageField);
