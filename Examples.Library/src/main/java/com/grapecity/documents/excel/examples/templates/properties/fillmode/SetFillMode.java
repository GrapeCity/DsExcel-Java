...
public class SetFillMode extends ExampleBase {

	@Override
	public void execute(Workbook workbook) {
        //Load template file from resource
        InputStream templateFile = this.getResourceStream("xlsx/Template_SetFillModeDefault.xlsx");
	...
	public String getTemplateName() {
        return "Template_SetFillModeDefault.xlsx";
	}
	...
	public String[] getResources() {
        return new String[] { "xlsx/Template_SetFillModeDefault.xlsx" };
	}
