...
public class TemplateWorkWithSparkline extends ExampleBase {

	@Override
	public void execute(Workbook workbook) {
        //Load template file from resource
        InputStream templateFile = this.getResourceStream("xlsx/Template_WorkWithSparkline.xlsx");
	...
	public String getTemplateName() {
        return "Template_WorkWithSparkline.xlsx";
	}
	...
	public String[] getResources() {
        return new String[] { "xlsx/Template_WorkWithSparkline.xlsx" };
	}
