...
public class GcMockResultSet implements ResultSet {
	private GcResultSetMetaData metaData = null;
	...
	public GcMockResultSet(InputStream inputStream) {

        IWorkbook workbook = new Workbook();
        workbook.open(inputStream, OpenFileFormat.Csv);
        this.worksheet = workbook.getActiveSheet();

        IRange dataRange = this.worksheet.getUsedRange(EnumSet.of(UsedRangeType.Data));
        this.rowCount = dataRange.getRowCount();
        this.colCount = dataRange.getColumnCount();

        this.metaData = new GcResultSetMetaData(this.worksheet);
	}
	...
	public Object getObject(int columnIndex) throws SQLException {
        return this.worksheet.getRange(this.rowIndex, columnIndex - 1).getValue();
	}
