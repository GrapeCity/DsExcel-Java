...
public class SetFillModeOverflow extends ExampleBase {

	@Override
	public void execute(Workbook workbook) {
        //Load template file from resource
        InputStream templateFile = this.getResourceStream("xlsx/Template_SetFillModeOverflow.xlsx");
	...
	public String getTemplateName() {
        return "Template_SetFillModeOverflow.xlsx";
	}
	...
	public String[] getResources() {
        return new String[] { "xlsx/Template_SetFillModeOverflow.xlsx" };
	}
