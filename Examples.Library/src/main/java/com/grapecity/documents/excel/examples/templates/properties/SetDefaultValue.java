...
public class SetDefaultValue extends ExampleBase {

	@Override
	public void execute(Workbook workbook) {
        //Load template file from resource
        InputStream templateFile = this.getResourceStream("xlsx/Template_SetDefaultValue.xlsx");
	...
	public String getTemplateName() {
        return "Template_SetDefaultValue.xlsx";
	}
	...
	public String[] getResources() {
        return new String[] { "xlsx/Template_SetDefaultValue.xlsx" };
	}
