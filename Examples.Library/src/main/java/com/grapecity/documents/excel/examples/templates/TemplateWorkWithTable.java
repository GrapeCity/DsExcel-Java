...
public class TemplateWorkWithTable extends ExampleBase {

	@Override
	public void execute(Workbook workbook) {
        //Load template file from resource
        InputStream templateFile = this.getResourceStream("xlsx/Template_WorkWithTable.xlsx");
	...
	public String getTemplateName() {
        return "Template_WorkWithTable.xlsx";
	}
	...
	public String[] getResources() {
        return new String[] { "xlsx/Template_WorkWithTable.xlsx" };
	}
