package com.grapecity.documents.excel.examples.templates.style;
...
import com.grapecity.documents.excel.examples.templates.templatecell.DataInfo;

public class MergeCell extends ExampleBase {
	@Override
